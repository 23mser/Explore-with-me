...
public class EventServiceImpl implements EventService {
    ...
    private List<StatDto> getEventsViewsList(List<Event> events) {
    ...
    private void createNewHit(String ip, String url) {
        ...
        HitDto endpointHitDto = new HitDto(serviceName, url, ip, LocalDateTime.now());
    ...
    private Map<String, Long> getEventViewsMap(List<StatDto> viewStatDtosList) {
        Map<String, Long> eventViews = new HashMap<>();


        for (StatDto viewStat : viewStatDtosList) {
